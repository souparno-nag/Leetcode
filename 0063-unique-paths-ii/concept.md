...
There are certain obstacles placed along the path. The robot cannot pass through an obstacle.
Given: M, N
...
If the cell is an obstacle, there is no path through it.
